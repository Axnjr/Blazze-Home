...
export default function Docs() {
    return (
        <div className='w-full h-fit relative mt-40 pt-20 text-center m-auto overflow-hidden flex flex-col justify-center items-center'>
            ...
            <h1 className='text-4xl sm:text-5xl md:text-5xl tracking-tighter font-[700] px-4'>
                Start Building with Blazze.js
            </h1>

            <div className='px-20 md:px-0 max-w-xl m-auto mt-12 mb-10 text-md  text-neutral-500'>
            ...
            <div className="w-full h-fit grid place-items-center py-20">
                <h1 className="text-4xl sm:text-5xl md:text-6xl tracking-tighter font-black px-4 my-8">Try it yourself !!</h1>
                <div className="w-11/12 h-screen mt-12 shadow-[0_0_8rem_-0.5rem_#3b82f6] rounded-2xl">
