	...
	return (
		<>
			<main className="w-full m-auto h-fit pt-20 overflow-hidden bg-white dark:bg-black text-black dark:text-white">
				...
				<Features />
				<Docs />
				<div className='py-12 w-full h-12 border-t flex items-center justify-between px-12'>
					<span>Written in React x TypeScript with devotion by <a className="underline" href="https://twitter.com/YC59094"> Axn</a>. Improve this page on <a className="underline" href="https://github.com/Axnjr/Blazze.js">Github</a>.</span>
