...
function Links(){
	return <div className="flex flex-col-reverse gap-3 md:flex-row">
		<div className="flex gap-2 md:gap-4 items-center">
			...
			dark:bg-neutral-900 group bg-neutral-100 hover:bg-neutral-200" target="_blank" rel="noreferrer" href="https://github.com/typehero/typehero">
			...
			<a className="p-2 rounded-xl px-3 dark:hover:bg-neutral-800 flex items-center
			dark:bg-neutral-900 group bg-neutral-100 hover:bg-neutral-200" target="_blank" rel="noreferrer" href="https://twitter.com/typeheroapp">
