            ...
            <div className="mx-auto  mb-[64px] grid max-w-[1400px] items-center justify-center px-4 sm:px-24 md:px-4 lg:px-24">
                <div className="flex flex-col  items-center justify-center gap-16">
                    <div className="mt-1 flex flex-col gap-3 px-4 text-center sm:px-0">
                        ...
                        <h1 id='features' className='text-3xl sm:text-5xl lg:text-6xl leading-8 my-10 tracking-tighter font-black'>
                            What's in Blazze ?
                        </h1>
                        ...
                        <div className='relative z-10 grid w-full gap-4 md:grid-cols-1 lg:grid-cols-2 lg:gap-4'>
                            {
                                features.map((f, id) => {
                                    return <FeatureCard key={id} className='w-[100%] h-fit hover:shadow-2xl shadow-blue-500'>
                                        <div className='group w-full h-52 md:h-44 p-8 rounded-xl flex 
                                            ...
                                            <h1 className='tracking-tighter font-black text-2xl lg:text-3xl m-4 flex items-center bg-gradient-to-r
